...
public class AuthorizedControllerHelper {
    ...
    public static final String buildBasicAuthHeaderValue(String username, String password) throws Exception {
        ...
        String encodingData = authHeaderFormat + new String(Base64.encodeBase64Chunked(encodingRawData.getBytes("utf-8")));
        return encodingData;
    }
    ...
    public static String buildDigestAuthenticateion(MockMvc mvc, String username,
        ...
        assertNotNull(authItems.get("realm"));
        assertNotNull(authItems.get("nonce"));
        assertNotNull(authItems.get("qop"));
